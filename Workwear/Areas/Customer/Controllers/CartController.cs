    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM = new ShoppingCartVM
            {
                ...
                includeProperties: "ProductSize.Product"),
                OrderHeader = new()
            };
        ...
        public IActionResult Summary()
        {
            ...
            ShoppingCartVM.OrderHeader.ApplicationUser = _unitOfWork.ApplicationUser.Get(t=>t.Id == userId);
        ...
        public IActionResult SummaryPOST()
        {
            ...
            ApplicationUser applicationUser = _unitOfWork.ApplicationUser.Get(t => t.Id == userId);
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            // Вычитание Count из Quantity
            foreach (var cart in shoppingCarts)
            {
                var productSize = _unitOfWork.ProductSize.Get(p => p.Id == cart.ProductSizeId && p.SizeName == cart.Size, tracked: true);
                if (productSize != null)
                {
                    int newQuantity = productSize.Quantity - cart.Count;
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cartFromDb.Count <= 1)
            {
                ...
                HttpContext.Session.SetInt32(SD.SessionCart, _unitOfWork.ShoppingCart.GetAll
                    (x => x.ApplicationUserId == cartFromDb.ApplicationUserId).Count() - 1);
        ...
        private double GetPriceBasedOnQuantity(ShoppingCart shoppingCart)
        {
            ...
            {
                return shoppingCart.ProductSize.Product.Price;
            }
            else
            {
                if (shoppingCart.Count <= 50)
                {
                    return shoppingCart.ProductSize.Product.Price20;
                }
                else
                {
                    if (shoppingCart.Count <= 100)
                    {
                        return shoppingCart.ProductSize.Product.Price50;
                    }
                    else
                    {
                        return shoppingCart.ProductSize.Product.Price100;
                    }
                }
            }
        }
